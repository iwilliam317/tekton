...
def index(_resp):
    ...
    contexto = {'rest_salvar_path': to_path(rest.salvar), 'rest_listar_path' : to_path(rest.index), 'rest_deletar_path' : to_path(rest.deletar), 'rest_editar_path' : to_path(rest.editar) }
